...
| **WhatsApp + Messenger vía Meta Cloud API (Cloudflare)** | Otra sesión/chat (no identificada con nombre exacto — posiblemente hydrox-ai o Forja), corre en **Cloudflare Workers, no en Make** | Según reporte que Moises pegó de esa otra conversación (2026-09-22, **sin verificar desde esta sesión**): WABA aprobada, negocio HYDROX verificado ante Meta, app "HydroxBot" suscrita a mensajes, número de prueba +1 555 658 9965 funcionando, número real +502 4013 9559 registrado pero con una prueba end-to-end pendiente (el mensaje llegó a WhatsApp pero no al bot), secretos (App Secret/Verify Token/Page Access Token) guardados en Cloudflare. También reclama tener Messenger "conectado y probado, respondiendo". |

⚠️ **Conflicto potencial sin resolver:** esta sesión activó y controla el Messenger vía Make (escenario 5747741, "Sofia"). Si el sistema de Cloudflare de arriba también responde Messenger, hay **dos bots respondiendo al mismo Facebook Page** — riesgo de respuestas duplicadas/contradictorias a un mismo cliente. Antes de que cualquier sesión futura active o edite cualquiera de los dos lados de Messenger, hay que confirmar con Moises cuál de los dos debe quedar como el único activo.
